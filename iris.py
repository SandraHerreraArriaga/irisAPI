...
def iris_classifier(verbose=False):
    ...
    clf = clf.fit(iris.data, iris.target) #sobreescribe el clasificador ya entrenado
...
if __name__ == '__main__':
    iris_classifier(verbose=False) #true es para que genere el grafo
    #print(clf.predict(np.array([cuatro datos del iris]))
